...
export const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ 
  ...
  useEffect(() => {
    ...
    lightPath.animate(
      [
        { strokeDashoffset: lightPath.getTotalLength(), fillOpacity: 0 },
    ...
    setTimeout(() => {
      darkPath.animate(
        [
          { strokeDashoffset: darkPath.getTotalLength(), fillOpacity: 0 },
          { strokeDashoffset: 0, fillOpacity: 0, offset: 0.7 },
          { strokeDashoffset: 0, fillOpacity: 1 }
        ],
  ...
  return (
    <Link to="/" className={`block ${className}`}>
      ...
      >
        ...
        <path
          ref={lightPathRef}
          d="M60,40 C70,20 100,15 125,35 C145,50 125,70 85,70 C65,70 50,60 60,40"
          fill="#67a9ff"
          stroke="#67a9ff"
          strokeWidth="4"
        ...
        <path
          ref={darkPathRef}
          d="M85,70 C125,70 155,60 155,40 C155,20 135,20 115,35 C95,50 75,65 85,70"
          fill="#1e4086"
          stroke="#1e4086"
          strokeWidth="4"
          className="origin-center"
