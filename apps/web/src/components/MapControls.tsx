...
const MapControls: React.FC<MapControlsProps> = ({
  ...
  showCluster, setShowCluster,
  showDottedLine, setShowDottedLine,
  showCustomIcons, setShowCustomIcons,
  showDataDriven, setShowDataDriven,
  ...
  return (
    <Card className="absolute top-4 left-4 z-10 w-64 shadow-lg bg-background/90 backdrop-blur-sm">
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Checkbox 
            id="cluster-toggle" 
            checked={showCluster} 
            onCheckedChange={(checked) => setShowCluster(!!checked)} 
            disabled={isLoading} 
          />
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            disabled={isLoading || (!showCluster && !showHeatmap)}
            className="w-full"
          />
